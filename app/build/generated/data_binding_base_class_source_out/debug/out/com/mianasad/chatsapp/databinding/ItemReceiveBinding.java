...
public final class ItemReceiveBinding implements ViewBinding {
  ...
  private ItemReceiveBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView feeling,
  ...
  public static ItemReceiveBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.feeling;
      ImageView feeling = rootView.findViewById(id);
      if (feeling == null) {
        break missingId;
      }
      ...
      return new ItemReceiveBinding((ConstraintLayout) rootView, feeling, image, linearLayout2,
          message);
    }

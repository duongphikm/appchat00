...
public final class ActivityOTPBinding implements ViewBinding {
  ...
  private ActivityOTPBinding(@NonNull ConstraintLayout rootView, @NonNull Button continueBtn,
      @NonNull ImageView imageView, @NonNull OtpView otpView, @NonNull TextView phoneLbl,
  ...
  public static ActivityOTPBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityOTPBinding((ConstraintLayout) rootView, continueBtn, imageView, otpView,
          phoneLbl, textView4);
    }
